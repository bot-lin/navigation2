...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__TRIDENT_CONTROL_ACTION_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__TRIDENT_CONTROL_ACTION_HPP_
...
public:
  /**
   * @brief A constructor for nav2_behavior_tree::nav2_msgs::action::TridentControl
   * @param xml_tag_name Name for the XML tag for this node
   * @param action_name Action name this node creates a client for
   * @param conf BT node configuration
   */
  TridentControlAction(
...
#endif  // NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__TRIDENT_CONTROL_ACTION_HPP_
