...
#ifndef NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__PUB_BOOL_TOPIC_NODE_HPP_
#define NAV2_BEHAVIOR_TREE__PLUGINS__ACTION__PUB_BOOL_TOPIC_NODE_HPP_
 ...
 */
class PubBoolTopic : public BT::SyncActionNode
{
public:
  /**
