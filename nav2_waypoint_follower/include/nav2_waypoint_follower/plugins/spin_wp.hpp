...
#ifndef NAV2_WAYPOINT_FOLLOWER__PLUGINS__SPIN_WP_HPP_
#define NAV2_WAYPOINT_FOLLOWER__PLUGINS__SPIN_WP_HPP_
#pragma once
 ...
 *
 */
class SpinWp : public nav2_core::WaypointTaskExecutor
{
public:
/**
...
protected:
  ...
  rclcpp_action::Client<nav2_msgs::action::Spin>::SharedPtr spin_client_ptr_;
};

}  // namespace nav2_waypoint_follower
#endif  // NAV2_WAYPOINT_FOLLOWER__PLUGINS__SPIN_WP_HPP_
