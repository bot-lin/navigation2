...
#ifndef NAV2_WAYPOINT_FOLLOWER__PLUGINS__DRIVE_ON_WP_HPP_
#define NAV2_WAYPOINT_FOLLOWER__PLUGINS__DRIVE_ON_WP_HPP_
#pragma once
 ...
 *
 */
class DriveOnWp : public nav2_core::WaypointTaskExecutor
{
public:
/**
 ...
 */
  ...
  void result_callback(const rclcpp_action::ClientGoalHandle<nav2_msgs::action::DriveOnHeading>::WrappedResult & result);
protected:
  ...
  rclcpp_action::Client<nav2_msgs::action::DriveOnHeading>::SharedPtr driveon_client_ptr_;
};

}  // namespace nav2_waypoint_follower
#endif  // NAV2_WAYPOINT_FOLLOWER__PLUGINS__DRIVE_ON_WP_HPP_
