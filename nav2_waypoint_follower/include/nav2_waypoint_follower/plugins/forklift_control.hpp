...
#ifndef NAV2_WAYPOINT_FOLLOWER__PLUGINS__FORKLIFT_CONTROL_HPP_
#define NAV2_WAYPOINT_FOLLOWER__PLUGINS__FORKLIFT_CONTROL_HPP_
#pragma once
 ...
 *
 */
class ForkliftControl : public nav2_core::WaypointTaskExecutor
{
public:
/**
...
protected:
  ...
  int height_control; //unit mm
  bool is_enabled_;
  rclcpp::Logger logger_{rclcpp::get_logger("nav2_waypoint_follower")};
  rclcpp::Publisher<std_msgs::msg::UInt64MultiArray>::SharedPtr fork_height_publisher_;
};

}  // namespace nav2_waypoint_follower
#endif  // NAV2_WAYPOINT_FOLLOWER__PLUGINS__FORKLIFT_CONTROL_HPP_
