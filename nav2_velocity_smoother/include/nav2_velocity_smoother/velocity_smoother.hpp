...
#include "nav2_msgs/msg/vel_smoother.hpp"
...
protected:
  ...
  void VelSmootherParameterCallback(const nav2_msgs::msg::VelSmoother::SharedPtr msg);
  ...
  rclcpp::Subscription<nav2_msgs::msg::VelSmoother>::SharedPtr parameter_sub_;
